...
public class Reusable_Actions {
    ...
    public static void Submit(WebDriver driver, String xpathLocator,ExtentTest logger){
        ...
        try{
            ...
            element.submit();
            logger.log(LogStatus.PASS,"Successfully submited ");
        }catch (Exception X){
            System.out.println("Unable to click on element "+ X);
            logger.log(LogStatus.PASS,"Failed to submit ");
        }
    }// end of submit method
    ...
    /*Robot reusable method can be use when you come across where you click on upload file
    and a pop up appears for you to attach a uploaded file. You need to
    call the entire absolute path of target file as an argument*/
